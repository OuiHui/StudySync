        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          <div className="flex items-start space-x-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
                ...
                {adminMember && (
                  <div className="flex items-center gap-1.5 text-xs text-gray-400">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 font-medium text-gray-300 hover:text-white hover:underline cursor-pointer focus:outline-none"
                    >
              ...
              <p className="text-sm text-gray-400 dark:text-gray-400 mt-2.5 max-w-2xl leading-relaxed">
          ...
          <div className="flex flex-col items-start md:items-end gap-4 shrink-0">
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs text-gray-400 font-medium hidden sm:inline">Members:</span>
                ...
                {members.slice(0, 4).map((member, index) => {
                  ...
                  return member.avatar && isValidImageUrl(member.avatar) ? (
                    <button
                      ...
                      className="inline-block h-8 w-8 rounded-full ring-2 ring-[#141414] focus:outline-none hover:scale-110 hover:z-10 transition-transform cursor-pointer"
                      title={member.name}
                    >
                      <img
                    ...
                    <button
                      key={member.id}
                      onClick={() => openProfile(member.id)}
                      className={`inline-block h-8 w-8 rounded-full ring-2 ring-[#141414] flex items-center justify-center text-xs font-semibold text-white focus:outline-none hover:scale-110 hover:z-10 transition-transform cursor-pointer ${
